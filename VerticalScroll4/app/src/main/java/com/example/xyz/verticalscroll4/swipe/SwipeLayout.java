package com.example.xyz.verticalscroll4.swipe;

/**
 * Created by xyz on 2016/9/21.
 */
...
import com.example.xyz.verticalscroll4.R;
...
public class SwipeLayout extends FrameLayout {
    ...
    public interface SwipeListener {
        void onStartOpen(SwipeLayout layout);//开始滑动到新一页
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if(!mOnSwipeScrollListeners.isEmpty()){//触发滑动监听
            for(OnSwipeScrollListener l:mOnSwipeScrollListeners){
                l.onScroll(SwipeLayout.this,surfaceLeft,surfaceTop);
            }
        }
